...
VALUES
  ...
  ('HOME_TOPIC_CARDS', '[{"eyebrow":"ROOM DINING","title":"客房送餐专场","subtitle":"扫码识别房间后即可下单，配送费与起送金额按后台配置自动展示","linkType":"ROOM","linkValue":"","tone":"amber"},{"eyebrow":"PRIVATE DINING","title":"包间预订推荐","subtitle":"十个包间支持早餐、中餐、晚餐预约，可先预点菜再到店","linkType":"PRIVATE_ROOM","linkValue":"","tone":"tea"},{"eyebrow":"BANQUET","title":"婚宴寿宴咨询","subtitle":"线上留资，营业时间内优先人工电话跟进，适合婚礼和大型宴席","linkType":"BANQUET","linkValue":"","tone":"copper"}]', '首页活动专题卡片'),
